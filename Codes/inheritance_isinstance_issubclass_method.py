...
print(isinstance(u,Person))
print(isinstance(s,Person))
print(isinstance(p1,Sports))
print(isinstance(u,Sports))

print(issubclass(University_details,Person))
print(issubclass(Sports,University_details))
print(issubclass(Sports,Person))
print(issubclass(Person, University_details))
# print(u.__dict__)
# print(p1.full_name())
